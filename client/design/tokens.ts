...
/* bell — unread delivery signal + notification record */
...
.yolo-scope .capture--top { gap: 8px; border-bottom: 1px solid var(--y-line); }
.yolo-scope .capture--foot { align-items: flex-end; border-top: 1px solid var(--y-line); padding: 10px 16px; }
...
.yolo-scope .capture--foot .cap-input { min-height: 36px; max-height: 160px; height: auto; padding: 7px 12px; background: var(--y-surface-2); border: 1px solid transparent; border-radius: var(--y-r-md); line-height: 20px; resize: none; overflow-y: auto; transition: all var(--y-dur-2); }
...
.yolo-scope .p-main { max-width: 840px; margin: 0 auto; padding: 6px 28px 48px; }
...
.yolo-scope .notification-log__head { flex: none; min-height: 62px; display: flex; align-items: center; gap: 12px; padding: 10px 10px 10px 16px; border-bottom: 1px solid var(--y-line); }
.yolo-scope .notification-log__head > div { min-width: 0; flex: 1; }
.yolo-scope .notification-log__head h2 { margin: 0; color: var(--y-text-1); font-size: 16px; line-height: 1.3; outline: none; }
.yolo-scope .notification-log__head p { margin: 3px 0 0; color: var(--y-text-3); font-size: 11.5px; }
.yolo-scope .notification-log__body { flex: 1; min-height: 0; overflow-y: auto; padding: 8px 12px 24px; }
.yolo-scope .notification-log__partial, .yolo-scope .notification-log__error { flex: none; margin: 0; padding: 8px 12px; border-bottom: 1px solid var(--y-line); color: var(--y-text-2); background: var(--y-surface-2); font-size: 12px; }
.yolo-scope .notification-log__error { display: flex; align-items: center; justify-content: space-between; gap: 8px; color: var(--y-danger); }
.yolo-scope .notification-log__group > h3 { position: sticky; top: -8px; z-index: 1; margin: 0; padding: 10px 2px 6px; background: var(--y-surface); color: var(--y-text-3); font-size: 11px; font-weight: 600; }
.yolo-scope .notification-log__group ol { list-style: none; margin: 0; padding: 0; }
.yolo-scope .notification-log__item { position: relative; margin-bottom: 7px; padding: 11px 11px 10px; border: 1px solid var(--y-line); border-radius: var(--y-r-md); background: var(--y-surface); outline: none; }
.yolo-scope .notification-log__item.is-new { border-left: 2px solid var(--y-accent); padding-left: 10px; }
.yolo-scope .notification-log__item:focus-visible { box-shadow: 0 0 0 3px var(--y-accent-soft); border-color: var(--y-accent); }
.yolo-scope .notification-log__meta { display: flex; align-items: center; gap: 6px; margin-bottom: 6px; color: var(--y-text-3); font-size: 11px; }
.yolo-scope .notification-log__meta > span { display: inline-flex; align-items: center; gap: 5px; color: var(--y-text-2); font-weight: 600; }
.yolo-scope .notification-log__meta b { padding: 1px 5px; border-radius: var(--y-r-pill); background: var(--y-accent-soft); color: var(--y-accent-text); font-size: 10px; }
.yolo-scope .notification-log__meta time { margin-left: auto; font-family: var(--y-font-mono); font-variant-numeric: tabular-nums; }
.yolo-scope .notification-log__item > strong { display: block; color: var(--y-text-1); font-size: 13px; line-height: 1.45; }
.yolo-scope .notification-log__item > p { margin: 5px 0 0; color: var(--y-text-2); font-size: 12px; line-height: 1.55; white-space: pre-wrap; display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; overflow: hidden; }
.yolo-scope .notification-log__item > p.is-expanded { display: block; overflow: visible; }
...
.yolo-scope .notification-log__skeleton { display: grid; gap: 8px; padding-top: 4px; }
.yolo-scope .notification-log__skeleton span { display: block; height: 94px; border: 1px solid var(--y-line); border-radius: var(--y-r-md); background: var(--y-surface-2); animation: yolo-skel 1.2s ease-in-out infinite alternate; }
@keyframes yolo-skel { from { opacity: .55; } to { opacity: 1; } }
...
.yolo-scope .row.inprog .ctl { position: relative; border-color: var(--y-accent); overflow: hidden; }
...
/* History is one fact stream with two projections: chronological and by subject. */
.yolo-scope .history-view { width: 100%; min-width: 0; padding-bottom: 48px; color: var(--y-text-1); }
.yolo-scope .history-view__header { display: flex; align-items: flex-end; justify-content: space-between; gap: 16px; padding: 8px 0 14px; border-bottom: 1px solid var(--y-line); }
.yolo-scope .history-view__header > div:first-child { min-width: 0; }
.yolo-scope .history-view__header h2 { margin: 0; font-size: 20px; line-height: 1.35; }
.yolo-scope .history-view__header p { margin: 4px 0 0; color: var(--y-text-2); font-size: 13px; }
.yolo-scope .history-view__filters { display: flex; align-items: flex-end; justify-content: flex-end; gap: 7px; min-width: 0; flex-wrap: wrap; }
.yolo-scope .history-view__filters label { display: inline-flex; align-items: center; gap: 6px; min-height: 36px; color: var(--y-text-3); font-size: 12px; white-space: nowrap; }
.yolo-scope .history-view__filters input { min-height: 36px; padding: 0 10px; border: 1px solid var(--y-line-strong); border-radius: var(--y-r-sm); background: var(--y-surface); color: var(--y-text-1); font: inherit; }
.yolo-scope .history-view__filters input[type="date"] { width: 145px; }
.yolo-scope .history-view__filters input[type="search"] { width: min(190px, 22vw); }
.yolo-scope .history-time-toggle { min-height: 36px; padding: 0 10px; border: 1px solid var(--y-line-strong); border-radius: var(--y-r-sm); background: var(--y-surface); color: var(--y-text-2); font-size: 12px; cursor: pointer; white-space: nowrap; }
.yolo-scope .history-time-toggle:hover { background: var(--y-surface-2); color: var(--y-text-1); }
.yolo-scope .history-status { padding: 12px 0 4px; }
.yolo-scope .history-partial,
.yolo-scope .history-error { margin: 12px 0 0; padding: 9px 11px; border: 1px solid var(--y-line-strong); border-left: 3px solid var(--y-focus); border-radius: var(--y-r-sm); background: var(--y-surface-2); color: var(--y-text-2); font-size: 13px; }
.yolo-scope .history-error { display: flex; align-items: center; justify-content: space-between; gap: 12px; border-left-color: var(--y-danger); }
.yolo-scope .history-error button,
.yolo-scope .history-more { min-height: 34px; padding: 0 12px; border: 1px solid var(--y-line-strong); border-radius: var(--y-r-sm); background: var(--y-surface); color: var(--y-text-1); cursor: pointer; }
.yolo-scope .history-loading { display: grid; gap: 9px; padding: 24px 0; }
.yolo-scope .history-loading span { height: 46px; border-radius: var(--y-r-sm); background: linear-gradient(90deg, var(--y-surface-2), var(--y-hover), var(--y-surface-2)); background-size: 200% 100%; animation: yolo-skeleton 1.2s linear infinite; }
.yolo-scope .history-day { margin-top: 22px; }
.yolo-scope .history-day > h3 { display: flex; align-items: baseline; gap: 8px; margin: 0 0 5px; color: var(--y-text-1); font-size: 14px; }
.yolo-scope .history-day > h3 span { color: var(--y-text-3); font-family: var(--y-font-mono); font-size: 11px; font-weight: 500; }
.yolo-scope .history-events,
.yolo-scope .history-items { margin: 0; padding: 0; list-style: none; }
.yolo-scope .history-event { display: grid; grid-template-columns: 58px minmax(0, 1fr); gap: 12px; min-width: 0; }
.yolo-scope .history-event__rail { position: relative; display: flex; justify-content: flex-end; padding-top: 12px; color: var(--y-text-3); font-family: var(--y-font-mono); font-size: 11px; font-variant-numeric: tabular-nums; }
.yolo-scope .history-event__rail::after { content: ""; position: absolute; top: 0; right: -13px; bottom: 0; width: 1px; background: var(--y-line); }
.yolo-scope .history-event__rail span { position: absolute; z-index: 1; top: 15px; right: -16px; width: 7px; height: 7px; border: 2px solid var(--y-surface); border-radius: 50%; background: var(--y-text-3); }
.yolo-scope .history-event__body { min-width: 0; padding: 10px 0 14px 12px; border-bottom: 1px solid var(--y-line); }
.yolo-scope .history-event__head { display: flex; align-items: center; gap: 8px; color: var(--y-text-3); font-size: 11px; }
.yolo-scope .history-event__kind { padding: 2px 6px; border: 1px solid var(--y-line-strong); border-radius: 999px; color: var(--y-text-2); font-weight: 650; }
.yolo-scope .history-event__workspace { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.yolo-scope .history-event__body > strong { display: block; margin-top: 6px; color: var(--y-text-1); font-size: 13px; line-height: 1.5; overflow-wrap: anywhere; }
.yolo-scope .history-event__body > p { margin: 5px 0 0; color: var(--y-text-2); font-size: 12px; }
.yolo-scope .history-event__changes { display: grid; gap: 4px; margin: 7px 0 0; }
.yolo-scope .history-event__changes > div { display: grid; grid-template-columns: 68px minmax(0, 1fr); gap: 8px; font-size: 12px; }
.yolo-scope .history-event__changes dt { color: var(--y-text-3); }
.yolo-scope .history-event__changes dd { display: flex; flex-wrap: wrap; gap: 5px; min-width: 0; margin: 0; color: var(--y-text-2); }
.yolo-scope .history-event__changes dd span { overflow-wrap: anywhere; }
.yolo-scope .history-event__changes dd b { color: var(--y-text-3); font-weight: 500; }
.yolo-scope .history-event__foot { display: flex; flex-wrap: wrap; align-items: center; gap: 4px 10px; margin-top: 7px; color: var(--y-text-3); font-size: 11px; }
.yolo-scope .history-event__foot button { display: inline-flex; align-items: center; gap: 4px; min-height: 26px; padding: 0; border: 0; background: none; color: var(--y-text-2); cursor: pointer; }
.yolo-scope .history-event__foot span { display: inline-flex; align-items: center; gap: 4px; }
.yolo-scope .history-items { margin-top: 10px; border: 1px solid var(--y-line-strong); border-radius: var(--y-r-md); background: var(--y-surface); overflow: hidden; }
.yolo-scope .history-item { border-bottom: 1px solid var(--y-line); }
.yolo-scope .history-item:last-child { border-bottom: 0; }
.yolo-scope .history-item__main { display: grid; grid-template-columns: minmax(180px, 1.2fr) minmax(160px, 1fr) auto; align-items: center; gap: 14px; padding: 12px 14px; }
.yolo-scope .history-item__toggle { display: flex; align-items: flex-start; gap: 8px; min-width: 0; min-height: 34px; padding: 0; border: 0; background: none; color: var(--y-text-1); text-align: left; cursor: pointer; }
.yolo-scope .history-item__toggle > svg { flex: none; margin-top: 5px; transition: transform var(--y-dur-1); }
.yolo-scope .history-item__toggle > svg.up { transform: rotate(180deg); }
.yolo-scope .history-item__toggle > span { min-width: 0; }
.yolo-scope .history-item__toggle strong,
.yolo-scope .history-item__toggle small { display: block; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.yolo-scope .history-item__toggle strong { font-size: 13px; }
.yolo-scope .history-item__toggle small { margin-top: 3px; color: var(--y-text-3); font-size: 11px; }
.yolo-scope .history-item__summary { min-width: 0; color: var(--y-text-3); font-size: 11px; }
.yolo-scope .history-item__summary time { margin-left: 8px; font-family: var(--y-font-mono); }
.yolo-scope .history-item__summary p { margin: 4px 0 0; overflow: hidden; color: var(--y-text-2); font-size: 12px; text-overflow: ellipsis; white-space: nowrap; }
.yolo-scope .history-item__actions { display: flex; flex-wrap: wrap; justify-content: flex-end; gap: 5px; }
.yolo-scope .history-item__actions button { min-height: 32px; padding: 0 9px; border: 1px solid var(--y-line-strong); border-radius: var(--y-r-sm); background: var(--y-surface); color: var(--y-text-1); cursor: pointer; }
.yolo-scope .history-subject-events { padding: 0 14px 14px; background: var(--y-surface-2); }
.yolo-scope .history-subject-events .history-event { grid-template-columns: 50px minmax(0, 1fr); }
.yolo-scope .history-inline-state { margin: 0; padding: 10px 14px 14px; background: var(--y-surface-2); color: var(--y-text-3); font-size: 12px; }
.yolo-scope .history-inline-state.is-error { color: var(--y-danger); }
.yolo-scope .history-more { display: block; width: 100%; margin-top: 12px; }

@media (max-width: 700px) {
  .yolo-scope .history-view__header { align-items: stretch; flex-direction: column; }
  .yolo-scope .history-view__filters { align-items: stretch; justify-content: stretch; }
  .yolo-scope .history-view__filters label { flex: 1; }
  .yolo-scope .history-view__filters input[type="date"], .yolo-scope .history-view__filters input[type="search"] { width: 100%; }
  .yolo-scope .history-time-toggle { flex: none; }
  .yolo-scope .history-item__main { grid-template-columns: minmax(0, 1fr); gap: 7px; }
  .yolo-scope .history-item__actions { justify-content: flex-start; }
  .yolo-scope .history-event { grid-template-columns: 42px minmax(0, 1fr); gap: 8px; }
  .yolo-scope .history-event__changes > div { grid-template-columns: 58px minmax(0, 1fr); }
}
...
.yolo-scope .dock-input { flex: none; display: flex; align-items: flex-end; padding: 10px 12px; border-top: 1px solid var(--y-line); }
.yolo-scope .dock-input input, .yolo-scope .dock-input textarea { flex: 1; min-height: 36px; max-height: 120px; height: auto; padding: 7px 12px; border: 1px solid transparent; border-radius: var(--y-r-md); background: var(--y-surface-2); color: var(--y-text-1); font-size: 13.5px; line-height: 20px; outline: none; resize: none; overflow-y: auto; transition: all var(--y-dur-2); }
.yolo-scope .dock-input input::placeholder, .yolo-scope .dock-input textarea::placeholder { color: var(--y-text-3); }
.yolo-scope .dock-input input:focus, .yolo-scope .dock-input textarea:focus { background: var(--y-bg); border-color: var(--y-line-strong); box-shadow: 0 0 0 3px var(--y-accent-soft); }
...
.yolo-scope .v2-today-surface > header { padding: 28px 0 16px; border-bottom: 1px solid var(--y-line); }
...
.yolo-scope .v2-today-surface > header h1 { margin: 8px 0 7px; font-size: 28px; line-height: 1.2; letter-spacing: -.02em; }
...
.yolo-scope .v2-judgment--full { border-left: 3px solid var(--y-focus); border-top: 1px solid var(--y-line-strong); }
...
.yolo-scope .v2-judgment--compact .v2-judgment-actions button { width: auto; }
...
.yolo-scope .v2-task-section-head { display: flex; align-items: baseline; justify-content: space-between; gap: 12px; margin-bottom: 8px; }
.yolo-scope .v2-task-section-head > h2 { margin: 0; font-size: 15px; line-height: 1.4; }
.yolo-scope .v2-task-section-head > span { color: var(--y-text-3); font-family: var(--y-font-mono); font-size: 13px; font-variant-numeric: tabular-nums; }
.yolo-scope .v2-task-list { margin: 0; padding: 0 14px; list-style: none; border: 1px solid var(--y-line-strong); border-radius: var(--y-r-md); background: var(--y-surface); overflow: hidden; }
.yolo-scope .v2-today-row { display: grid; grid-template-columns: 24px minmax(0, 1fr) auto; align-items: start; gap: 10px; min-width: 0; padding: 12px 0; border-bottom: 1px solid var(--y-line); transition: background var(--y-dur-1); }
.yolo-scope .v2-today-row:last-child { border-bottom: 0; }
...
.yolo-scope.compact .capture--top { padding-inline: 12px; }
.yolo-scope.compact .capture-submit { padding-inline: 10px; }
