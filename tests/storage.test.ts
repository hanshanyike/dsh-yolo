...
describe('db + schema', () => {
  it('opens and creates all tables', () => {
    ...
    for (const t of ['meta', 'user_profile', 'milestones', 'todos', 'todo_evidence', 'goals', 'preferences', 'preference_history', 'events', 'extraction_log', 'todo_resolution_log', 'pending_reminders', 'yolo_fts', 'todo_identity_fts']) {
